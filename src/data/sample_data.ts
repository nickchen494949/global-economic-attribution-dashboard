...
const us: CountryData = {
  ...
  scores: { asset_score: cs(55, 0.20, 58, 3, 3), equity_score: cs(74, 0.65, 74, 5, 5), bond_score: cs(62, 0.30, 62, 5, 5), currency_score: cs(34, -0.40, 34, 5, 5), macro_score: cs(56, 0.25, 60, 28, 28), growth_score: cs(56, 0.14, 56, 5, 5), labor_score: cs(68, -0.20, 68, 3, 3), inflation_score: cs(40, 0.25, 40, 4, 4), external_balance_score: cs(42, -0.19, 42, 5, 5), fiscal_score: cs(44, -0.30, 44, 4, 4), credit_score: cs(58, 0.11, 58, 6, 6), risk_score: cs(50, 0.0, 50, 31, 31), country_alpha: 0.0, true_alpha: 0.0, alpha_vs_global: null, alpha_vs_region: null, alpha_vs_development_stage: null, alpha_vs_global_role: null, alpha_vs_openness: null, alpha_vs_external_vulnerability: null },
...
const ca: CountryData = {
  ...
  scores: { asset_score: cs(50, 0.10, 54, 2, 3), equity_score: cs(60, 0.25, 60, 5, 5), bond_score: cs(null, null, null, 0, 5), currency_score: cs(54, 0.10, 54, 5, 5), macro_score: cs(48, -0.05, 48, 27, 28), growth_score: cs(42, -0.23, 42, 5, 5), labor_score: cs(54, 0.38, 54, 2, 3), inflation_score: cs(48, -0.04, 48, 4, 4), external_balance_score: cs(48, -0.04, 48, 5, 5), fiscal_score: cs(50, 0.05, 50, 4, 4), credit_score: cs(52, 0.23, 52, 6, 6), risk_score: cs(48, -0.05, 48, 29, 31), country_alpha: -2.0, true_alpha: -1.5, alpha_vs_global: null, alpha_vs_region: null, alpha_vs_development_stage: null, alpha_vs_global_role: null, alpha_vs_openness: null, alpha_vs_external_vulnerability: null },
...
const mx: CountryData = {
  ...
  scores: { asset_score: cs(45, -0.15, 45, 2, 3), equity_score: cs(64, 0.35, 64, 5, 5), bond_score: cs(null, null, null, 0, 5), currency_score: cs(26, -0.65, 26, 5, 5), macro_score: cs(64, 0.50, 68, 27, 28), growth_score: cs(73, 0.61, 73, 5, 5), labor_score: cs(85, 0.20, 85, 2, 3), inflation_score: cs(31, 0.51, 31, 4, 4), external_balance_score: cs(59, 0.25, 59, 5, 5), fiscal_score: cs(44, -0.05, 44, 4, 4), credit_score: cs(73, 0.15, 73, 6, 6), risk_score: cs(55, 0.15, 55, 29, 31), country_alpha: 5.2, true_alpha: 3.8, alpha_vs_global: null, alpha_vs_region: null, alpha_vs_development_stage: null, alpha_vs_global_role: null, alpha_vs_openness: null, alpha_vs_external_vulnerability: null },
...
const de: CountryData = {
  ...
  scores: { asset_score: cs(65, 0.55, 72, 2, 3), equity_score: cs(78, 0.75, 78, 5, 5), bond_score: cs(null, null, null, 0, 5), currency_score: cs(68, 0.45, 68, 5, 5), macro_score: cs(44, -0.20, 42, 28, 28), growth_score: cs(26, -0.78, 26, 5, 5), labor_score: cs(49, 0.45, 49, 3, 3), inflation_score: cs(38, -0.31, 38, 4, 4), external_balance_score: cs(61, 0.21, 61, 5, 5), fiscal_score: cs(58, -0.08, 58, 4, 4), credit_score: cs(52, -0.07, 52, 6, 6), risk_score: cs(55, 0.18, 55, 30, 31), country_alpha: 8.0, true_alpha: -3.5, alpha_vs_global: null, alpha_vs_region: null, alpha_vs_development_stage: null, alpha_vs_global_role: null, alpha_vs_openness: null, alpha_vs_external_vulnerability: null },
...
const ch: CountryData = {
  ...
  scores: { asset_score: cs(60, 0.40, 66, 2, 3), equity_score: cs(60, 0.25, 60, 5, 5), bond_score: cs(null, null, null, 0, 5), currency_score: cs(80, 0.80, 80, 5, 5), macro_score: cs(55, 0.18, 57, 27, 28), growth_score: cs(42, -0.22, 42, 5, 5), labor_score: cs(63, -0.65, 63, 2, 3), inflation_score: cs(30, -0.53, 30, 4, 4), external_balance_score: cs(74, 0.49, 74, 5, 5), fiscal_score: cs(70, 0.18, 70, 4, 4), credit_score: cs(45, 0.13, 45, 6, 6), risk_score: cs(58, 0.28, 58, 29, 31), country_alpha: 3.0, true_alpha: 2.0, alpha_vs_global: null, alpha_vs_region: null, alpha_vs_development_stage: null, alpha_vs_global_role: null, alpha_vs_openness: null, alpha_vs_external_vulnerability: null },
...
const se: CountryData = {
  ...
  scores: { asset_score: cs(62, 0.45, 68, 2, 3), equity_score: cs(76, 0.70, 76, 5, 5), bond_score: cs(null, null, null, 0, 5), currency_score: cs(60, 0.25, 60, 5, 5), macro_score: cs(48, -0.08, 47, 27, 28), growth_score: cs(35, -0.41, 35, 5, 5), labor_score: cs(45, 0.30, 45, 2, 3), inflation_score: cs(54, 0.09, 54, 4, 4), external_balance_score: cs(61, 0.27, 61, 5, 5), fiscal_score: cs(67, 0.01, 67, 4, 4), credit_score: cs(45, -0.03, 45, 6, 6), risk_score: cs(55, 0.18, 55, 29, 31), country_alpha: 5.0, true_alpha: 1.5, alpha_vs_global: null, alpha_vs_region: null, alpha_vs_development_stage: null, alpha_vs_global_role: null, alpha_vs_openness: null, alpha_vs_external_vulnerability: null },
...
const tw: CountryData = {
  ...
  scores: { asset_score: cs(78, 1.00, 84, 2, 3), equity_score: cs(93, 1.50, 93, 5, 5), bond_score: cs(null, null, null, 0, 5), currency_score: cs(56, 0.15, 56, 5, 5), macro_score: cs(75, 1.00, 84, 27, 28), growth_score: cs(91, 1.42, 91, 5, 5), labor_score: cs(68, -0.10, 68, 2, 3), inflation_score: cs(41, -0.23, 41, 4, 4), external_balance_score: cs(93, 1.40, 93, 5, 5), fiscal_score: cs(69, -0.28, 69, 4, 4), credit_score: cs(63, 0.08, 63, 6, 6), risk_score: cs(78, 1.00, 82, 29, 31), country_alpha: 25.0, true_alpha: 22.0, alpha_vs_global: null, alpha_vs_region: null, alpha_vs_development_stage: null, alpha_vs_global_role: null, alpha_vs_openness: null, alpha_vs_external_vulnerability: null },
